...
function configuredProject(){try{return execFileSync("cmd.exe",["/d","/s","/c","gcloud config get-value project"],{encoding:"utf8",stdio:["ignore","pipe","ignore"]}).trim();}catch{return"";}}
